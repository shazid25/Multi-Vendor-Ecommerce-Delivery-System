...
// Import your routes (Ensure these paths match your project)
// import productRoutes from './routes/productRoutes.js';

const app: Express = express(); // Explicit type fix for TS2742
...
// IMPORTANT: This MUST come before express.json() so it can read the raw stream
app.all("/api/auth/*", (req, res) => {
  return toNodeHandler(auth)(req, res);
});
